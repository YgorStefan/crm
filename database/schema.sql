...
CREATE TABLE IF NOT EXISTS clients (
    ...
    notes             TEXT            NULL,
    birth_date        DATE            NULL,                -- data de nascimento (formato YYYY-MM-DD)
    referido_por      VARCHAR(150)    NULL,                -- nome de quem indicou (quando source=Indicação)
...
-- ------------------------------------------------------------
-- TABELA: client_sales
-- Cada linha representa uma venda (cota de consórcio) de um cliente.
-- Um cliente pode ter múltiplas cotas. Os dados pessoais ficam em
-- clients; os dados comerciais de cada cota ficam aqui.
-- ------------------------------------------------------------
CREATE TABLE IF NOT EXISTS client_sales (
    id                  INT UNSIGNED    AUTO_INCREMENT PRIMARY KEY,
    client_id           INT UNSIGNED    NOT NULL,
    grupo               VARCHAR(50)     NULL,
    cota                VARCHAR(50)     NULL,
