...
- [x] **Phase 10: Edição de Histórico de Contatos** - Permite editar entradas existentes de interações e anotações na ficha do cliente (completed 2026-03-27)
...
- [x] 09-02-PLAN.md — BUG-03 + CAL-10 + CAL-11: frontend — renovação CSRF, botões Excluir/Concluída, strikethrough no calendário
...
- [x] 10-02-PLAN.md — CLI-10 + CLI-11: frontend — edição inline de interações e notas em show.php
