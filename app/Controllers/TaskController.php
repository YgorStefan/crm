...
class TaskController extends Controller
{
    ...
    public function upcoming(array $params = []): void
    {
        ...
        // CAL-09: Aniversarios — estrutura pronta, retorna vazio ate Phase 2 adicionar birth_date
        // Quando Phase 2 criar coluna clients.birth_date, adicionar query:
        // SELECT name FROM clients WHERE DATE_FORMAT(birth_date, '%m-%d') = DATE_FORMAT(NOW(), '%m-%d')
        // e gerar alertas com type='birthday'
