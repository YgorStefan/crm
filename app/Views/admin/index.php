...
<div class="flex items-center justify-between mb-4">
    <div>
        ...
        <p class="text-sm text-gray-500 dark:text-zinc-400 mt-1"><?= htmlspecialchars($tabs[$activeTab], ENT_QUOTES, 'UTF-8') ?></p>
    </div>
...
<!-- Tabs -->
<div class="flex flex-wrap gap-1 mb-4 border-b border-gray-200 dark:border-zinc-800" role="tablist">
