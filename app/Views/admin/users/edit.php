    ...
    <form method="POST" action="<?= APP_URL ?>/admin/users/<?= $user['id'] ?>/update"
        ...
        <div class="px-6 py-5 space-y-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <label for="is_active" class="text-sm text-gray-700 dark:text-zinc-300">Usuário ativo</label>
            </div>
        </div>
        <div class="px-6 py-4 bg-gray-50 dark:bg-zinc-800/30 flex justify-between gap-3">
