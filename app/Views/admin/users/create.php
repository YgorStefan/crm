...
<div class="max-w-lg mx-auto">
    ...
    <form method="POST" action="<?= APP_URL ?>/admin/users/store"
        ...
        <div class="px-6 py-5 space-y-4">
            <div>
                <label for="user_name" class="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-1">Nome <span class="text-red-500">*</span></label>
                <input type="text" id="user_name" name="name" required class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none">
            </div>
            <div>
                <label for="user_email" class="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-1">E-mail <span class="text-red-500">*</span></label>
                <input type="email" id="user_email" name="email" required class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none">
            </div>
            <div>
                <label for="user_password" class="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-1">Senha <span class="text-red-500">*</span> <span class="text-xs text-gray-400">(mín. <?= MIN_PASSWORD_LENGTH ?> caracteres)</span></label>
                <input type="password" id="user_password" name="password" required minlength="<?= MIN_PASSWORD_LENGTH ?>" class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="url" id="user_avatar" name="avatar" placeholder="https://..."
