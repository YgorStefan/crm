<?php
/**
 * View: tasks/index.php — Calendario de Tarefas (FullCalendar 6)
 * Variaveis: $tasks, $overdue, $users, $filters, $csrf_token
 */
?>

<!-- Alerta: Tarefas Atrasadas (CAL-06: corrigido com CONVERT_TZ) -->
...
<!-- Calendario FullCalendar (CAL-01) -->
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
    <div id="fc-calendar"></div>
</div>

<!-- Modal: Criacao e Edicao de Tarefa (compartilhado) -->
...
<!-- Modal: Conflito de dia (CAL-04) -->
<div id="modalDayConflict" class="hidden fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 p-4">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // CAL-01: Inicializa calendario FullCalendar em pt-BR com visualizacao mes/semana
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        // CAL-03: Eventos carregados do feed JSON backend
        events: appUrl + '/api/tasks/calendar',
        // CAL-02 / CAL-04: Clicar em data
        dateClick: function(info) {
            handleDateClick(info.dateStr);
        },
        // CAL-05: Clicar no titulo do evento abre modal de edicao
    ...
    // CAL-04: Verifica se ja existem eventos no dia clicado
    ...
    // CAL-02: Abre modal de criacao com data pre-preenchida
    ...
    // CAL-05: Abre modal de edicao carregando dados via API
    ...
    // CAL-04: Botoes do dialog de conflito
    ...
    // Expoe calendario para uso futuro (Plan 02 - notificacoes)
