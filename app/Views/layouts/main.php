    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-sidebar text-white flex flex-col transform -translate-x-full transition-transform duration-300 lg:relative lg:translate-x-0">
        ...
        <div class="px-4 py-4 border-t border-indigo-800">
            <div class="flex items-center gap-3">
                ...
                <a href="<?= APP_URL ?>/logout" title="Sair" class="text-indigo-300 hover:text-white flex-shrink-0 transition-colors">
        ...
        <header class="bg-white border-b border-gray-200 px-4 sm:px-6 py-3 flex items-center justify-between flex-shrink-0 z-10 relative">
            <div class="flex items-center gap-3 w-full">
                ...
                <div class="relative ml-auto" id="notification-bell">
                    <button id="btnNotifications" class="relative text-gray-500 hover:text-indigo-600 transition-colors p-1" title="Notificacoes">
                    ...
                    <div id="notifDropdown" class="hidden absolute right-0 top-full mt-2 w-80 bg-white rounded-xl shadow-xl border border-gray-200 z-50 max-h-64 overflow-y-auto">
                        <div class="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
                            <span class="text-sm font-semibold text-gray-700">Notificacoes</span>
                            <button id="btnClearNotifs" class="text-xs text-indigo-600 hover:underline">Limpar</button>
                        </div>
...
<script>
// ====================================================
// NOTIFICATION SYSTEM (CAL-07, CAL-08, CAL-09)
