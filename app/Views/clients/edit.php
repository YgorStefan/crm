        ...
        <div class="px-6 py-5 border-b border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="source" id="source_select" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                ...
                <div id="indicacao_wrapper" <?= (val($client,'source') !== 'Indicação') ? 'style="display:none;"' : '' ?> class="md:col-span-2">
...
// Máscara: CPF/CNPJ dinâmico (CLI-02)
...
// Campo condicional: Indicação (CLI-06)
