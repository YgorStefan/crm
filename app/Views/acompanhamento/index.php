...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Volume semanal de contatos importados vs. abordados (últimas 4
                semanas)</p>
        </div>
    </div>
    ...
    <?php if (!$temDados): ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
            ...
            <p class="text-sm text-gray-400 mt-1">Importe uma lista em <a href="<?= APP_URL ?>/cold-contacts"
                    class="text-indigo-600 hover:underline">Contatos Frios</a> para começar.</p>
        </div>
    <?php else: ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div class="flex items-center gap-3">
                    ...
                    <select id="filtroLista"
                        class="text-sm border border-gray-300 rounded-lg px-3 py-1.5 text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500">
