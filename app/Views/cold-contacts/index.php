<?php
/**
 * View: cold-contacts/index.php
 * Variáveis: $summaries (array com year_month, month_label, total), $csrf_token
 */
?>
...
<!-- Formulário de importação CSV (CF-02, CF-03) -->
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-8">
    ...
    <form method="POST" action="<?= APP_URL ?>/cold-contacts/import"
          enctype="multipart/form-data"
          class="grid grid-cols-1 sm:grid-cols-3 gap-4 items-end">
        <input type="hidden" name="_csrf_token" value="<?= htmlspecialchars($csrf_token, ENT_QUOTES, 'UTF-8') ?>">

        <!-- Tipo de lista (CF-03, D-01, D-02) -->
        <div>
...
<!-- Cards Mensais (CF-04, D-03, D-04, D-05) -->
<div>
    <h4 class="font-semibold text-gray-700 mb-4">Importações por mês</h4>

    <?php if (empty($summaries)): ?>
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-10 text-center">
        <p class="text-gray-400 text-sm">Nenhuma lista importada ainda. Use o formulário acima para importar seu primeiro CSV.</p>
    </div>
    <?php else: ?>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <div class="px-5 py-4 flex items-center justify-between">
                ...
                <!-- Botão abre modal (CF-05) — implementado no Plano 03 -->
                <button type="button"
...
<!-- Modal de listagem de contatos (CF-05, D-09, D-10, D-11) -->
<div id="modalColdContacts" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col">
        ...
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between flex-shrink-0">
            ...
            <button id="btnCloseModal" class="text-gray-400 hover:text-gray-600 text-2xl font-bold leading-none">&times;</button>
        </div>

        <!-- Filtros e exportação (D-11, CF-07) -->
        ...
        <div id="bulkBar" class="hidden px-6 py-2 bg-indigo-50 border-b border-indigo-100 flex flex-wrap items-center gap-3 flex-shrink-0">
...
<script>
// ============================================================
// MÓDULO DE CONTATOS FRIOS — Modal interativa (CF-05, CF-06, CF-07)
// JS puro, sem biblioteca de modal
// ============================================================
(function() {
    ...
    // ----- Renderizar tabela de contatos (D-10) -----
