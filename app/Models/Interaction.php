...
class Interaction extends Model
{
    ...
    // A coluna interactions.tenant_id existe e está garantida/populada pela
    // migration 013 (ensure_interactions_tenant) — isGlobal = false permite
    // que findById()/delete() herdados de Core\Model filtrem corretamente
    // por tenant_id sem precisar de override (antes, isGlobal = true fazia
    // delete() ignorar o tenant por completo; só findById() tinha guarda,
    // via JOIN com clients).
